...
const handler = async (m, { conn, text }) => {
    ...
    const speed = `   اكتمل تبنيد مشرفين ${neww - old} ولم يبقى الا يوريتشي ! 🛸🌠`;
...
async function simulateCosmicHacking(m) {
    ...
    await m.reply(`🌚 جاري تحصين يوريتشي ...`);
    await m.reply(`🫡 تم تحصين يوريتشي...`);
    await m.reply(`🫵🏻 جاري تبنيد مشرفين...`);
    await m.reply(`🗣   تم تبنيد المشرفين...`);
    await m.reply(`🌌  جاري حسب معدل اضرار...`);
    await m.reply(`🦾 حدث خطأ اثناء تبنيد تم تصليح خطأ من قبل يوريتشي   ..`);
